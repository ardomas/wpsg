...
class WPSG_IndicatorAttributesData extends WPSG_DataBase {
    ...
    protected function generate_table_structure(): void {
        global $wpdb;
        $table_config = [
            'table_name' => $wpdb->base_prefix . 'wpsg_indicator_attributes',
            'columns' => [
            ...
            'indexed' => [
                ...
                ['name'=>'idx_normal'     ,                   'field'=>'site_id, name, slug, sort_order' ],
            ],
        ];
