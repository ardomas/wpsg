...
class WPSG_PersonActivitiesData extends WPSG_DataBase {
    ...
    protected function generate_table_structure(): void{
        ...
        $table_config = [
            ...
            'columns' => [
                ...
                ['name'=>'time_check'     , 'type'=>'TIME'    , 'null'=>true ],
                ['name'=>'time_leave'     , 'type'=>'TIME'    , 'null'=>true ],
                ['name'=>'date_publish'   , 'type'=>'DATETIME', 'null'=>true ],
                ['name'=>'note_by_teacher', 'type'=>'TEXT'    , 'null'=>true ],
                ['name'=>'note_by_parent' , 'type'=>'TEXT'    , 'null'=>true ],
            ],
            'indexed' => [ 
                ['name'=>'person_idx',                   'field'=>'site_id, person_id, date_record, date_publish, time_check, time_leave, deleted_at' ],
