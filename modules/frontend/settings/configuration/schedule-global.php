...
$default_schedule = $json_data['schedules']['global'] ?? [];
...
?><div class="form">
    ...
    <div class="row">
        <div class="col-12 wpsg-grid-border-bottom py-2" id="schedule-global-area-data" style="height: 420px; overflow-y: scroll;">
            <div class="row">
        ...
        <div class="col-12 text-center py-2 d-block" id="schedule-global-command">
            <div class="wpsg-grid-data text-center py-2"><span class="form-label" id="schedule-global-area-info">&nbsp;</span></div>
            <button type="button" id="btn-schedule-global-data-save" class="btn btn-process" style="width: 240px;">
        ...
        (()=>{
            document.addEventListener('DOMContentLoaded', function(){
                ...
                const schedule_global = (class {
                    ...
                    constructor(){
                        this.data_area_id = 'schedule-global-area-data';
                        this.info_area_id = 'schedule-global-area-info';
                    ...
                    register_events(){
                        document.getElementById('btn-schedule-global-data-save').addEventListener('click', (e)=>{
                            e.preventDefault();
                            this.save_data();
                        });
                    }
                ...
                //
                const sched_global = new schedule_global();
                sched_global.init();
                //
            });
        })();
