...
class WPSG_SettingsPlatformPrivate {

    private $option_key = 'wpsg_platform_private';
    private $data = [];
    ...
    private function save() {
        if (!wp_verify_nonce($_POST['wpsg_platform_private_nonce'], 'wpsg_save_platform_private')) {
            return;
        }
    ...
    public function render() {
        ...
        <form method="post" action="">
            ...
            <p>
                <button type="button" id="add-platform-private" class="button">Add Platform</button>
            </p>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                const table = document.getElementById('platform-private-table').getElementsByTagName('tbody')[0];
                const addBtn = document.getElementById('add-platform-private');
