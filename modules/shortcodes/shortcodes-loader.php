...
add_shortcode('wpsg_sc_profile_about'   , 'wpsg_shortcode_about_us'     );
add_shortcode('wpsg_sc_profile_legal'   , 'wpsg_shortcode_legal'        );
add_shortcode('wpsg_sc_profile_values'  , 'wpsg_shortcode_values'       );

add_shortcode('wpsg_sc_members_list'    , 'wpsg_shortcode_memberships'  );
